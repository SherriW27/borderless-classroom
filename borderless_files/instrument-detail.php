                    ...
                    <div class="mx-3 py-3 row gx-5">
                        <div class="col-4">
                            <div class="bg-body border ratio ratio-1x1">
                                <img class="object-fit-contain p-2" src="/borderless/instrument_images/<?= $row["category_name"] ?>/<?= $row["subcategory_name"] ?>/<?= $row["img"] ?>" alt="商品:<?= $row["name"] ?>">
                            </div>
                        </div>
                        <div class="col-8 pe-2">
                            <table class="table table-striped-columns">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="col-10 border-end"><?= $row["info"] ?></td>
                                </tr>
                                <tr class="row">
